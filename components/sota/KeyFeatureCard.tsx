...
export default function KeyFeatureCard({ feature, index }: KeyFeatureCardProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-[#1d1a1d] to-[#161316] border border-[#453027] rounded-xl p-5 hover:border-[#FF6D29]/30 transition-colors"
    >
      {/* Icon */}
      <div className="w-10 h-10 rounded-lg bg-[#FF6D29]/10 border border-[#FF6D29]/20 flex items-center justify-center mb-4">
