...
const sections = [
  {
    ...
    description: 'The bimanual manipulation problem, approach landscape, and our solution',
    icon: (
  ...
  },
  {
    href: '/sota',
    title: 'VLA Model',
    description: 'VLA input/output specification, model landscape, and EO-1 selection rationale',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
