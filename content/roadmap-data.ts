  ...
  phases: [
    ...
    // Phase 8: Sim-to-Real Preparation
    {
      ...
      subphases: [
        ...
        {
          id: '8.2',
          title: 'Alex Action Space Mapping',
          classification: 'HUMAN-CRITICAL',
          estimatedDays: 3,
          tasks: [
            { title: 'Document Alex kinematic structure', deliverable: 'Alex specification document' },
            { title: 'Design action space mapping (sim -> Alex)', deliverable: 'Mapping specification' },
            { title: 'Identify embodiment differences', deliverable: 'Embodiment gap analysis' },
            { title: 'Plan adaptation strategy', deliverable: 'Alex adaptation plan' },
          ],
        },
        {
          id: '8.3',
